...
ActiveRecord::Schema.define(version: 2020_03_11_161617) do
  ...
  create_table "substitutions", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["meal_id"], name: "index_substitutions_on_meal_id"
    t.index ["product_id"], name: "index_substitutions_on_product_id"
  end
  ...
  add_foreign_key "substitutions", "meals"

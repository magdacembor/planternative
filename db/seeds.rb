...
@products = [
  ...
  { name: "Quorn Vegan Fishless Fingers", price_range: "£", low_cal: false, high_protein: false, gluten_free: true, description: "Quorn Vegan Fishless Fingers are low in saturated fat and perfect for an easy family dinner. Or when only a crispy fishless finger sandwich will do!", ingredients: "Rice Flake (Rice, Emulsifier: Sodium Alginate), Wheat Flour (contains added Calcium, Iron, Niacin & Thiamine), Mycoprotein (12%), Water, Natural Flavouring, Rapeseed Oil, Stabiliser: Methylcellulose; Yeast, Salt, Paprika, Colour: Paprika Extract.", protein_per_100g: 4.5, fat_per_100g: 7.8, calories_per_100g: 214, carbs_per_100g: 29, user_id: 2, water_saved: 480, energy_saved: 2.2 }
